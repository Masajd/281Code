...
public class PhysicsVector 
{
	...
	**/
	...
	/** Adds together all the doubles in an array of doubles
	*   and then returns the sum to the main
	*
	...
	**/
	...
	/**Prints the physicsvector array to the screen in the form
	* b[i]= xi+yj+zk for all vectors in the array
	*
	*@param b The physicsvector array to be printed
	**/
	...
	/**Sets all values in a physicsvector arrayy to zero
	*
	*@param c The physicsvector array to be converted to 0
	*@param a A physicsvector array containing only 0s
	**/
	public static void SetArrayToZero(PhysicsVector[] c)	
	{
